...
/// <summary>
/// M10 Final VR2 R3 Requalification 2. Test-only exact-v9-equivalent shadow composition after the bounded H.28.1-E fusion repair.
...
/// </summary>
public sealed class M10FinalVr2R3ShortExactV9EquivalentShadowCompositionRequalification2Tests
{
    private const string OptInEnvironmentVariable = "NRS_M10_FINAL_VR2_R3_REQUALIFICATION2";
    ...
    [Fact(Explicit = true)]
    [Trait("Category", "M10FinalVr2R3ShortExactV9EquivalentShadowCompositionRequalification2")]
    public void R3_RepairedMode2Shadow_PreservesExactV9EquivalentShortHealthOwnershipAndDeterminism()
    {
        RequireOptIn();
    ...
    private static string ArtifactDirectory()
        => Path.Combine(
            FindRepositoryRoot(),
            "artifacts",
            "m10-final-physical-reference-vr2-r3-short-exact-v9-equivalent-shadow-composition-requalification2");
