...
public sealed class M10973MissionPerformanceWorkspaceUiTests
{
    ...
    public void ArtifactSummary_WritesM10973LiveWorkspaceEvidence()
    {
        ...
        {
            "scope=M10.9.7.3 Hotfix 1 REV2 live Mission/Performance workspace wiring over M10.9.7.2 Hotfix 3 REV1 VALIDATED; original M10.9.7.3 candidate superseded/not validated after two compile-contract failures; Hotfix 1 superseded/not validated after stale batch-presentation ordering plus an over-broad historical shell assertion; Hotfix 1 REV1 superseded/not validated after the scoped historical shell assertion retained an obsolete direct LogicalStepText expectation; presentation/application aggregation only; no new challenge definition, scoring arithmetic, protection authority, plant command authority or physics change;",
