...
/// <summary>
/// RP1C C4 Exact-v9 Runtime Factor Isolation 1. Evidence-only exact-v9 timing under four
/// explicitly controlled single-factor runtime compilation modes. Adjacent modes change exactly one
/// factor while Dynamic PGO and ReadyToRun remain fixed. The test records comparative evidence only:
/// it does not promote a causal interpretation, select C4, mutate C4, or authorize production repair.
/// </summary>
public sealed class M10FinalVr2EngineeringRepairPlanning1Rp1cC4RuntimeFactorIsolation1Tests
{
    private const string OptInEnvironmentVariable = "NRS_M10_FINAL_VR2_REPAIR_PLANNING1_RP1C_C4_RUNTIME_FACTOR_ISOLATION1";
    private const string ModeEnvironmentVariable = "NRS_M10_FINAL_VR2_REPAIR_PLANNING1_RP1C_C4_RUNTIME_FACTOR_MODE";
    private const string RunIndexEnvironmentVariable = "NRS_M10_FINAL_VR2_REPAIR_PLANNING1_RP1C_C4_RUNTIME_FACTOR_RUN_INDEX";
    private const string ArtifactDirectoryRelative = "artifacts/m10-final-physical-reference-vr2-engineering-repair-planning1-rp1c-c4-runtime-factor-isolation1";
    ...
    [Fact(Explicit = true)]
    [Trait("Category", "M10FinalVr2EngineeringRepairPlanning1Rp1cC4RuntimeFactorIsolation1")]
    public void Rp1cC4RuntimeFactorIsolation1_MeasuresOneFreshSingleFactorModeProcess()
    {
        RequireOptIn();
    ...
    {
        "TIERING-OFF-QJ-OFF-QJFL-OFF" => new ModeSpec("TIERING-OFF-QJ-OFF-QJFL-OFF", "0", "0", "0", "0", "1"),
        "TIERING-ON-QJ-OFF-QJFL-OFF" => new ModeSpec("TIERING-ON-QJ-OFF-QJFL-OFF", "1", "0", "0", "0", "1"),
        "TIERING-ON-QJ-ON-QJFL-OFF" => new ModeSpec("TIERING-ON-QJ-ON-QJFL-OFF", "1", "0", "1", "0", "1"),
        "TIERING-ON-QJ-ON-QJFL-ON" => new ModeSpec("TIERING-ON-QJ-ON-QJFL-ON", "1", "0", "1", "1", "1"),
        _ => throw new InvalidOperationException("Unknown or missing runtime factor isolation mode: " + (value ?? "<null>")),
    };
