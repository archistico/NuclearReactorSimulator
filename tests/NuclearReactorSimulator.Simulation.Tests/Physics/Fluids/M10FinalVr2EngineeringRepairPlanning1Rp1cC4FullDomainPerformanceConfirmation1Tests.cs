...
/// <summary>
/// RP1C C4 Full-Domain Performance Confirmation 1. Performance-only evidence over the immutable
...
/// </summary>
public sealed class M10FinalVr2EngineeringRepairPlanning1Rp1cC4FullDomainPerformanceConfirmation1Tests
{
    private const string OptInEnvironmentVariable = "NRS_M10_FINAL_VR2_REPAIR_PLANNING1_RP1C_C4_FULL_DOMAIN_PERF1";
    private const string RunIndexEnvironmentVariable = "NRS_M10_FINAL_VR2_REPAIR_PLANNING1_RP1C_C4_PERF_RUN_INDEX";
    private const string ArtifactDirectoryRelative = "artifacts/m10-final-physical-reference-vr2-engineering-repair-planning1-rp1c-c4-full-domain-performance-confirmation1";
    ...
    [Fact(Explicit = true)]
    [Trait("Category", "M10FinalVr2EngineeringRepairPlanning1Rp1cC4FullDomainPerformanceConfirmation1")]
    public void Rp1cC4FullDomainPerformanceConfirmation1_MeasuresOneFreshProcess()
    {
        RequireOptIn();
        ...
        WriteProcessContract(processDirectory, runIndex, candidate, ceilings);
        ...
        WriteProcessSummary(processDirectory, runIndex, exactSamples, seamSamples, candidateAllocatedBytes, harnessAllocatedBytes, ceilings);
    }
    ...
    private static void WriteProcessContract(string directory, int runIndex, Rp1bAllocationNeutralVaporSeamCompleteTabulatedSurrogateCandidate candidate, PerformanceCeilings ceilings)
    {
    ...
    private static void WriteRuntimeContext(string directory, int runIndex, long wholeRegionAllocatedBytes, long candidateAllocatedBytes, long harnessAllocatedBytes, int gen0, int gen1, int gen2)
    {
    ...
    private static void WriteProcessSummary(string directory, int runIndex, TimingSample[] exactSamples, TimingSample[] seamSamples, long candidateAllocatedBytes, long harnessAllocatedBytes, PerformanceCeilings ceilings)
    {
