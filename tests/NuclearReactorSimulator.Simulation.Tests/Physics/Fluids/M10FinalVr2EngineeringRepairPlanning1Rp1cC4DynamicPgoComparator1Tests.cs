...
/// <summary>
/// RP1C C4 Exact-v9 Dynamic PGO Comparator 1. Evidence-only exact-v9 timing under two
/// explicitly controlled runtime modes that differ only in Dynamic PGO. TieredCompilation, QuickJit,
/// QuickJitForLoops and ReadyToRun remain fixed ON. The test records comparative evidence only:
/// it does not auto-promote PGO causality, select C4, mutate C4, or authorize production/runtime repair.
/// </summary>
public sealed class M10FinalVr2EngineeringRepairPlanning1Rp1cC4DynamicPgoComparator1Tests
{
    private const string OptInEnvironmentVariable = "NRS_M10_FINAL_VR2_REPAIR_PLANNING1_RP1C_C4_DYNAMIC_PGO_COMPARATOR1";
    private const string ModeEnvironmentVariable = "NRS_M10_FINAL_VR2_REPAIR_PLANNING1_RP1C_C4_DYNAMIC_PGO_MODE";
    private const string RunIndexEnvironmentVariable = "NRS_M10_FINAL_VR2_REPAIR_PLANNING1_RP1C_C4_DYNAMIC_PGO_RUN_INDEX";
    private const string ArtifactDirectoryRelative = "artifacts/m10-final-physical-reference-vr2-engineering-repair-planning1-rp1c-c4-dynamic-pgo-comparator1";
    ...
    [Fact(Explicit = true)]
    [Trait("Category", "M10FinalVr2EngineeringRepairPlanning1Rp1cC4DynamicPgoComparator1")]
    public void Rp1cC4DynamicPgoComparator1_MeasuresOneFreshPgoModeProcess()
    {
        RequireOptIn();
        ...
        PerformanceCeilings ceilings)
    {
        File.WriteAllLines(Path.Combine(directory, "01-process-contract.txt"), new[]
        {
            ...
            "dynamic-pgo-single-factor-only=True",
    ...
    {
        "PGO-OFF-QJFL-ON" => new ModeSpec("PGO-OFF-QJFL-ON", "1", "0", "1", "1", "1"),
        "PGO-ON-QJFL-ON" => new ModeSpec("PGO-ON-QJFL-ON", "1", "1", "1", "1", "1"),
        _ => throw new InvalidOperationException("Unknown or missing Dynamic PGO comparator mode: " + (value ?? "<null>")),
    };
