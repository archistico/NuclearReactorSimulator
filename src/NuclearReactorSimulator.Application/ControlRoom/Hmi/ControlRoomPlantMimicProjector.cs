    ...
    public static ControlRoomPlantMimicSnapshot Project(ControlRoomSnapshot snapshot)
    {
        ...
        var elements = new[]
        {
            ...
            new ControlRoomPlantMimicElementSnapshot(
                ...
                Display("EXCHANGE", electrical.GrossElectricalOutput),
        ...
        var connections = new[]
        {
            ...
            Connection("generator-grid", "generator", "grid", ControlRoomPlantMimicMedium.Electrical, "GRID EXCHANGE", DisplayValue(electrical.GrossElectricalOutput), $"{DisplayValue(electrical.Grid.Frequency)} · {DisplayValue(electrical.Grid.LineVoltage)}", Worst(electrical.GrossElectricalOutput), 0.91d, 0.48d,
