> **Current development checkpoint:** M10.9.4.1-D.1, D.2 and D.2 Hotfix 1 are locally user-validated. D.3.2 Hotfix 3 loaded desktop main-steam capacity rebalance is the active candidate; it preserves D.3.1 passive loss, D.3.2 admission isolation and the uniform PLANT renderer.

# Nuclear Reactor Simulator
> **Current candidate:** M10.9.4.1-D.3.2 Hotfix 3 — loaded desktop main-steam capacity rebalance. It retains the 28% desktop bias and 276.7 °C stop-out seed, changes only the loaded main-steam-line resistance from 1,000 to 850 Pa·s²/kg², and leaves synchronization at 1,000 Pa·s²/kg².
...
M3.1–M3.8, M4.1–M4.7, M5.1–M5.7, M6.1–M6.7, M7.1–M7.7, M8.1–M8.7 hotfix 2 and M9.1–M9.7 are validated; the M3–M9 gates are complete. M10.1–M10.9.4 are validated; M10.9.4 is the official milestone baseline. The M10.9.4.1 extended audit exposed a current-v2 seed energy/hydraulic imbalance that is now corrected and locally user-validated through the exact 300-second journey, explicit synchronization journey, zero-warning build and 895-test ordinary suite. M10.9.4.1-B.1–B.3, C.1–C.2 and D.1–D.2 Hotfix 1 are locally user-validated. D.3.2 Hotfix 3 loaded desktop main-steam capacity rebalance is the active candidate after Hotfix 1 local evidence identified the fully open stop valve as the initial bottleneck.
