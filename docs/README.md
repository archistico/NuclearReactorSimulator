...
- `GITHUB_ORDINARY_CI_STABLE_CONTRACT_V2.md` — permanent semantic ordinary-CI contract; supersedes Hotfix 1 as the active CI validator without rewriting Hotfix 1 provenance.
...
## Current VR2/R3 repair-planning documents

NRS-MARKER:DOCNAV-R3-ENERGY-TRANSPORT-REPAIR-PLANNING1

- `M10_FINAL_VR2_R3_ENERGY_TRANSPORT_OWNERSHIP_REPAIR_PLANNING1.md` - causal ownership option matrix and selected Family B transport-property contract.
- `M10_FINAL_VR2_R3_ENERGY_TRANSPORT_OWNERSHIP_REPAIR_PLANNING1_PREEXECUTION_REVIEW.md` - preimplementation review, stop conditions and local-authority policy.
