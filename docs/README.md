...
- [`M10_FINAL_VR2_ENGINEERING_REPAIR_PLANNING1_RP1B_C4_PLANNING1.md`](M10_FINAL_VR2_ENGINEERING_REPAIR_PLANNING1_RP1B_C4_PLANNING1.md) — active REV2 planning-only contract for a separately versioned allocation-neutral, C3-bit-equivalent test-only C4 candidate; corrects the R1 prefix topology, freezes allocation-neutral timing harness rules, source pins and the one-semantic-plus-ten-timing-process evidence protocol and separate state/hydraulic semantic schemas.
