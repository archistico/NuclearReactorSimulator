...
- `M10_9_4_1_H29_PRODUCTION_ACTIVATION_CANDIDATE.md` / `M10_9_4_1_H29_VALIDATION_CHECKLIST.md` / `M10_9_4_1_H29_STATIC_REVIEW.md` — validated H.29 exact-v3 corrected production candidate, exact-v2 explicit kill/rollback, internal telemetry and versioned replay/checkpoint qualification.
- `M10_9_4_1_H30_PHASE_H_CLOSURE_PRODUCTION_QUALIFICATION_DECISION.md` / `M10_9_4_1_H30_VALIDATION_CHECKLIST.md` / `M10_9_4_1_H30_STATIC_REVIEW.md` — current cumulative Phase H closure candidate; evidence-derived decision `OPT-IN ONLY`.
...
- `adr/0159-close-phase-h-opt-in-only-because-corrected-path-is-qualified-but-bounded-costly.md` — proposed H.30 closure decision: keep v2 explicit default and v3 corrected qualified opt-in because H.28 remains `bounded-but-costly`.
