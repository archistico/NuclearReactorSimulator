...
- **`M10_FINAL_VR2_ENGINEERING_REPAIR_PLANNING1_RP1C_C4_FULL_DOMAIN_PERFORMANCE_CONFIRMATION1_RETURNED_EVIDENCE_ADJUDICATION.md`** — authoritative returned full-domain evidence review; keeps C4 unselected because two rare exact-v9 single-call tails exceed the unchanged maximum.
- **`M10_FINAL_VR2_ENGINEERING_REPAIR_PLANNING1_RP1C_C4_EXACT_V9_WALL_CLOCK_TAIL_ATTRIBUTION_PLANNING1.md`** — active planning-only successor; freezes a four-mode fresh-process runtime/tiering attribution protocol without changing C4, exact-v9 or thresholds.
...
- [`M10_FINAL_VR2_ENGINEERING_REPAIR_PLANNING1_RP1C_C4_FULL_DOMAIN_PERFORMANCE_CONFIRMATION1_RETURNED_EVIDENCE_ADJUDICATION.md`](M10_FINAL_VR2_ENGINEERING_REPAIR_PLANNING1_RP1C_C4_FULL_DOMAIN_PERFORMANCE_CONFIRMATION1_RETURNED_EVIDENCE_ADJUDICATION.md) — authoritative returned confirmation review; accepts the complete 30-file tree as valid negative engineering evidence, freezes `C4-FULL-DOMAIN-PERFORMANCE-NOT-CONFIRMED` and keeps RP1C selection blocked pending bounded exact-v9 tail attribution planning.
