...
`INITIAL_CONDITIONS_SCENARIO_FRAMEWORK.md`, `OPERATIONAL_CHALLENGE_LIFECYCLE.md`, `PROTECTION_INTERLOCKS_TRIPS_SCRAM.md`, `DETERMINISTIC_FAULT_INJECTION_FRAMEWORK.md`, `RECORDER_CHECKPOINT_FULL_REPLAY.md`, `POST_INCIDENT_ANALYSIS.md`, `GAMEPLAY_LONG_RUNNING_SYSTEM_TESTS.md`, `REFERENCE_PLANT_SCALE_CONTRACT.md`.
