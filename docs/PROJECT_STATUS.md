> **Current authoritative numerical continuation:** M10.9.4.1-H.24 Requalification 1 post-H.28 VALIDATED, on top of H.28 VALIDATED (`bounded-but-costly`). **Current candidate:** M10.9.4.1-H.29 — Production Activation Candidate. Exact v2 remains the explicit authoritative default/kill reference; v3 is candidate-only until H.30.
...
| M10 | IN PROGRESS | M10.1–M10.9.4, M10.9.4.1 through H.28 and H.24 Requalification 1 post-H.28 are validated; H.28 is `bounded-but-costly`; current candidate is H.29 production activation candidate with v2 explicit retained as authoritative default; M10 closes at M10.9.8 |
...
**Continuation note:** M8.1–M8.7, M9.1–M9.7, M10.1–M10.9.4, M10.9.4.1 through H.28 and H.24 Requalification 1 post-H.28 are validated; Phase G is complete and standard production remains exact v2 explicit. H.28 is `bounded-but-costly`. The current candidate is H.29, which qualifies exact v3 corrected deployment selection, explicit v2 kill/rollback, internal telemetry and versioned replay/checkpoint without changing numerical mathematics. See `PROJECT_HANDOFF.md`, `NEW_CHAT_START.md`, `M10_9_4_1_H29_PRODUCTION_ACTIVATION_CANDIDATE.md`, `M10_9_4_1_PHASE_H_COMPLETION_ROADMAP_H24_H30.md` and `milestones/M10.9.4.1.md`.
