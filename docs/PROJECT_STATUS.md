...
> **Current authoritative numerical continuation:** M10.9.4.1-H.27 Hotfix 1 VALIDATED. **Validated performance diagnosis:** H.28.1-A Hotfix 2. **Validated implementation optimization:** H.28.1-C Hotfix 2. **Failed performance qualification:** H.28. **Current working source:** M10.9.4.1-H.28.1-B CANDIDATE — Historical Explicit Predictor Reuse. H.29 remains blocked.
...
| M10 | IN PROGRESS | M10.1–M10.9.4 and M10.9.4.1 through H.27 Hotfix 1 validated; Phase G complete; H.28 performance gate failed as evidence; H.28.1-A Hotfix 2 attribution and H.28.1-C Hotfix 2 allocation optimization are validated; H.28.1-B predictor reuse is validated; H.28.1-D probe CPU optimization is current; one H.24 rerun is deferred until performance optimization stabilizes; H.29 remains blocked; M10 closes at M10.9.8 |
...
**Continuation note:** M8.1–M8.7, M9.1–M9.7, M10.1–M10.9.4 and M10.9.4.1 through H.26 Hotfix 1 are validated; Phase G is complete and standard production current-v2 remains explicit. H.24 is retained as a rare long-horizon gate; H.25 qualified the targeted protection/transient matrix; H.26 qualified atomic integrated fallback. H.27 now maps a bounded off-design qualification envelope without rerunning H.24. See `PROJECT_HANDOFF.md`, `NEW_CHAT_START.md`, `M10_9_4_1_H27_OFF_DESIGN_ROBUSTNESS_QUALIFICATION_ENVELOPE.md`, `M10_9_4_1_PHASE_H_COMPLETION_ROADMAP_H24_H30.md` and `milestones/M10.9.4.1.md`.
