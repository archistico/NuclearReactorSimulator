> **Current authoritative continuation:** M10.9.4.1-H.30 Phase H Closure & Production Qualification Decision VALIDATED. Phase H is closed as `OPT-IN ONLY`; exact v2 explicit remains authoritative default/rollback/reference and exact v3 corrected remains qualified opt-in. **Current candidate:** M10.9.4.1-I.1 Hotfix 1 — Profile Compatibility & Legacy Retirement Inventory.
...
| M10 | IN PROGRESS | M10.1–M10.9.4 and M10.9.4.1 through H.30 are validated; Phase H is closed `OPT-IN ONLY`; current candidate is I.1 Hotfix 1 compatibility/legacy-retirement inventory; M10 closes at M10.9.8 |
...
**Continuation note:** M8.1–M8.7, M9.1–M9.7, M10.1–M10.9.4 and M10.9.4.1 through H.30 are validated. Phase H is closed as `OPT-IN ONLY`: v2 explicit remains authoritative default/rollback/reference and exact v3 corrected remains qualified opt-in. Phase I is active at I.1 Profile Compatibility & Legacy Retirement Inventory. See `PROJECT_HANDOFF.md`, `NEW_CHAT_START.md`, `M10_9_4_1_I1_PROFILE_COMPATIBILITY_LEGACY_RETIREMENT_INVENTORY.md` and `milestones/M10.9.4.1.md`.
