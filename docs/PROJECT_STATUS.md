...
| M10 | IN PROGRESS | M10.1–M10.9.4, M10.9.4.1 through H.30, I.1 Hotfix 1 and I.2 are validated; Phase H is closed `OPT-IN ONLY`; current candidate is I.3 reference trajectory/conservation-inventory baseline; M10 closes at M10.9.8 |
...
**Continuation note:** M8.1–M8.7, M9.1–M9.7, M10.1–M10.9.4, M10.9.4.1 through H.30, I.1 Hotfix 1 and I.2 are validated. Phase H is closed as `OPT-IN ONLY`: v2 explicit remains authoritative default/rollback/reference and exact v3 corrected remains qualified opt-in. Phase I current candidate is I.3 Reference Trajectories, Conservation/Inventory Baseline & Tolerance Budgets. See `PROJECT_HANDOFF.md`, `NEW_CHAT_START.md`, `M10_9_4_1_I3_REFERENCE_TRAJECTORY_CONSERVATION_INVENTORY_BASELINE.md` and `milestones/M10.9.4.1.md`.
