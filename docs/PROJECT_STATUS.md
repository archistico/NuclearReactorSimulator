> **Current authoritative numerical continuation:** M10.9.4.1-H.28 VALIDATED (`bounded-but-costly`). **Current candidate:** M10.9.4.1-H.24 Requalification 1 — Post-H.28 Committed Long-Horizon & Cross-Profile Regression. H.29 remains blocked until this single post-optimization long-horizon regression passes.
...
| M10 | IN PROGRESS | M10.1–M10.9.4 and M10.9.4.1 through H.28 validated; H.28 is `bounded-but-costly`; current candidate is the single post-H.28 H.24 long-horizon requalification; H.29 follows only after a green regression; M10 closes at M10.9.8 |
...
**Continuation note:** M8.1–M8.7, M9.1–M9.7, M10.1–M10.9.4 and M10.9.4.1 through H.28 are validated; Phase G is complete and standard production current-v2 remains explicit. H.28 is `bounded-but-costly`. The current candidate reruns H.24 once after the stabilized performance implementation, as required before H.29. See `PROJECT_HANDOFF.md`, `NEW_CHAT_START.md`, `M10_9_4_1_H24_POST_H28_REQUALIFICATION.md`, `M10_9_4_1_PHASE_H_COMPLETION_ROADMAP_H24_H30.md` and `milestones/M10.9.4.1.md`.
...
## H.24 post-H.28 requalification checkpoint

H.28 is VALIDATED and the optimization branch is stable. The corrected path remains `bounded-but-costly`, standard current-v2 remains explicit, and the current candidate is the single roadmap-required post-optimization H.24 long-horizon/cross-profile regression. H.29 remains blocked until build, ordinary tests and that focused gate are green.
