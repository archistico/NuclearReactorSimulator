> **Current validated continuation:** M10.9.4.1-H.18 Hotfix 1; Phase G complete and current-v2 production safely remains explicit at 10 ms. **Current working source:** M10.9.4.1-H.19 CANDIDATE — four-node long-horizon and cross-profile qualification.
...
M0 through M9 are validated, with M7, M8 and M9 gates complete. **M10.1–M10.9.4 and the cumulative M10.9.4.1-H.18 Hotfix 1 continuation are VALIDATED; Phase G is complete and production current-v2 remains explicit.** H.19 is the current four-node long-horizon/cross-profile shadow qualification candidate. The H.4-selected hybrid method remains non-authoritative numerical evidence only.

Approved future product direction remains frozen in `FUTURE_GAMEPLAY_CONTROL_ROOM_AND_ACCIDENT_DIRECTION.md` plus ADR 0121–0123. These decisions do **not** change the immediate numerical-hardening sequence. H.10–H.12 localized the original failures to inverse thermodynamic branch selection; H.13 Hotfix 2 validated bounded 2%/5 K continuity at `steam|stop-out`; H.15 localized interval 723 to the same mechanism at `header`; H.16 validated `steam|stop-out|header` at 15/15. H.17 Hotfix 6 validated the 30,000-interval/four-profile diagnostic contract: 3,046 P060/F040 trigger intervals, 92 episodes, 473 representatives, 228/473 three-node convergence and 245 failures, including a new `turbine-inlet` disagreement class. H.18 Hotfix 1 is now validated: unchanged H.9 plus unchanged 2%/5 K hysteresis at `steam|stop-out|header|turbine-inlet` converged 261/261 over all 245 H.17 failures plus 16 controls, recovered both the 120 mismatch and 125 non-mismatch failure classes, preserved all controls, remained committed-state transparent and left no residual failure. H.19 is the current candidate: reproduce the exact H.17 3,046/92/473 long-horizon contract and qualify the four-node target set over all 473 representatives before any activation design. Phase I remains deferred.
...
| M10 | IN PROGRESS | M10.1–M10.9.4 and M10.9.4.1 through H.18 Hotfix 1 validated; Phase G complete; H.19 four-node long-horizon/cross-profile qualification candidate prepared; M10 closes at M10.9.8 |
...
**Continuation note:** M8.1–M8.7, M9.1–M9.7, M10.1–M10.9.4 and M10.9.4.1-H.18 Hotfix 1 are validated; Phase G is complete and production current-v2 remains explicit. H.18 proved that the exact four-node shadow target set recovers all 245 frozen H.17 failures plus 16 controls with 261/261 convergence and no residual failure class. The current working source H.19 returns that unchanged policy to the complete H.17 30,000-interval / 3,046-trigger / 92-episode / 473-representative qualification contract, including exact representative-key matching and untargeted phase-mismatch detection. See `PROJECT_HANDOFF.md`, `NEW_CHAT_START.md`, `M10_9_4_1_H19_FOUR_NODE_LONG_HORIZON_CROSS_PROFILE_QUALIFICATION.md`, `milestones/M10.9.4.1.md` and `OPERATIONAL_ENVELOPE_NUMERICAL_HARDENING_PLAN.md`.
