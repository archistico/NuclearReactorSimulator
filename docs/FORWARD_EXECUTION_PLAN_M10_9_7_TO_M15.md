...
4. prove replay/checkpoint/same-seed operator-visible equivalence — **M10.9.8.4 Hotfix 1 VALIDATED**;
5. perform full manual HMI/keyboard acceptance — **M10.9.8.5 ACTIVE CANDIDATE**;
