...
1. Treat M10.9.4.1-H.20 as the current validated continuation baseline and use M10.9.4.1-H.21 as the working opt-in orchestrator shadow-wiring/telemetry candidate; standard current-v2 production remains explicit, and H.21 never commits its corrected candidate.
