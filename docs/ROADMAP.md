...
M10 is **IN PROGRESS**. M10.1–M10.9.4 and the cumulative M10.9.4.1-F.1 continuation are VALIDATED. D.4 passed 944 ordinary tests and all 17 unique explicit tests on 2026-07-25; D.4.1, E.2 Hotfix 1, E.3.1 Hotfix 1, E.3.2 Hotfix 3 and F.1 then passed all user-run gates on 2026-07-26. F.2 is the current conservative main-steam header-relief candidate. Presentation remains in Application/App; real plant automation remains in canonical M5 ownership.
...
- final manual schematic/HMI checklist passed; M10.9.4 is validated. The current validated F.1 baseline contains the corrected seed, D.3.2 Hotfix 3, operator valve station, D.4.1 replay/reset/travel hardening, 10 MWe bidirectional current-v2 migration, signed trajectory evidence, breaker-supervised delayed electrical protection and the isolated choked-flow capacity seam. F.2 is the current header-relief candidate.

### M10.9.4.1 Operational Envelope & Numerical Hardening — IN PROGRESS (F.1 validated; F.2 candidate)
...
- Phase F.1 validates the isolated ideal-vapor subcritical/choked capacity law; F.2 adds one conservative current-v2 atmospheric header-relief boundary with exact-once mass/internal-energy export; F.3 remains the separate turbine-bypass increment;
