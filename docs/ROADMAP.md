...
- **I.1 Hotfix 1 — Profile Compatibility & Legacy Retirement Inventory — CURRENT:** enumerate exact-version profile support, preserve save/replay-compatible identities, and classify historical numerical audit modes before any deletion;
- after I.1, consolidate historical audit execution/evidence before retiring audit-only numerical seams; then establish CI/reference-trajectory/known-limitations gates and the cumulative pre-M10.9.5 qualification.
