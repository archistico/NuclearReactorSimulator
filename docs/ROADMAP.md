...
M10 is **IN PROGRESS**. M10.1–M10.9.4, the cumulative M10.9.4.1 continuation through H.28 and H.24 Requalification 1 post-H.28 are VALIDATED; Phase G is complete and standard production remains exact v2 explicit at 10 ms. H.19–H.27 provide numerical/authority/ownership/replay/long-horizon/protection/rollback/off-design provenance. H.28 remains `bounded-but-costly`. The post-H.28 H.24 regression completed 30,008 runtime steps with 9,626 corrected commits, zero rollback/fallback/unsafe/untargeted disagreement and deterministic repeat. The current candidate is H.29 Production Activation Candidate: exact v3 corrected selection, explicit v2 kill/rollback/reference, internal production telemetry and exact-version replay/checkpoint qualification. H.30 retains the final activation decision. Phase I remains deferred under the H.24–H.30 completion roadmap.

H.18 Hotfix 1 validated the four-node split at 261/261. H.19 restored and passed the complete long-horizon/cross-profile 3,046/92/473 qualification at 473/473. H.20 validated fail-closed authority/rollback. H.21 Hotfix 1 validated the real orchestrator sidecar seam without corrected-state commitment. H.22 validated the first separately opt-in corrected-state ownership seam. H.23 Hotfix 2 validated replay/checkpoint and reverse-power protection interaction. H.24–H.27 qualified long-horizon, protection, rollback and off-design operation. H.28 qualifies performance/soak as `bounded-but-costly`, and H.24 Requalification 1 post-H.28 is green. The current task is H.29 Production Activation Candidate. Exact v2 remains explicit and authoritative until H.30.
...
### M10.9.4.1 Operational Envelope & Numerical Hardening — IN PROGRESS (validated through H.28 + H.24 Requalification 1 post-H.28; corrected path `bounded-but-costly`; current candidate H.29 Production Activation Candidate)
...
7. **H.29 — Production Activation Candidate — CURRENT:** separately review exact-v3 corrected configuration, exact-v2 explicit default/kill/rollback, telemetry and replay/checkpoint compatibility without inventing another numerical algorithm.
