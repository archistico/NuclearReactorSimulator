...
M10 is **IN PROGRESS**. M10.1–M10.9.4 and the cumulative M10.9.4.1-E.3.2 Hotfix 3 continuation are VALIDATED. D.4 passed 944 ordinary tests and all 17 unique explicit tests on 2026-07-25; D.4.1, E.2 Hotfix 1, E.3.1 Hotfix 1 and E.3.2 Hotfix 3 then passed all user-run gates on 2026-07-26. F.1 is the current isolated choked steam-flow capacity candidate. Presentation remains in Application/App; real plant automation remains in canonical M5 ownership.
...
- final manual schematic/HMI checklist passed; M10.9.4 is validated. The current validated E.3.2 Hotfix 3 baseline contains the corrected seed, D.3.2 Hotfix 3, operator valve station, D.4.1 replay/reset/travel hardening, 10 MWe bidirectional current-v2 migration, signed trajectory evidence and breaker-supervised delayed electrical protection. F.1 is the current capacity-law candidate.

### M10.9.4.1 Operational Envelope & Numerical Hardening — IN PROGRESS (E.3.2 Hotfix 3 validated; F.1 candidate)
...
- Phase F.1 isolates and audits the ideal-vapor subcritical/choked capacity law; later F increments add conservative relief and bypass topology only after that seam is green;
