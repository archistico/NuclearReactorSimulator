> **Current authoritative continuation:** M10.9.4.1-I.2 Audit Consolidation & CI Baseline Hardening VALIDATED. Phase H remains closed as `OPT-IN ONLY`; exact v2 explicit remains authoritative default/rollback/reference and exact v3 corrected remains qualified opt-in. **Current candidate:** M10.9.4.1-I.3 Hotfix 5 — Corrected 300 s Healthy Reference Requalification. Hotfix 4 diagnostic classification is green (338/338 exact-v2 drops coincide with targeted reverse flow; exact v3 0/0 over 100 s). I.3 remains unvalidated and budgets remain unfrozen.
...
| M10 | IN PROGRESS | M10.1–M10.9.4, M10.9.4.1 through H.30, I.1 Hotfix 1 and I.2 are validated; Phase H is closed `OPT-IN ONLY`; current candidate is I.3 Hotfix 5 corrected 300 s healthy-reference requalification; M10 closes at M10.9.8 |
...
**Continuation note:** M8.1–M8.7, M9.1–M9.7, M10.1–M10.9.4, M10.9.4.1 through H.30, I.1 Hotfix 1 and I.2 are validated. Phase H is closed as `OPT-IN ONLY`: v2 explicit remains authoritative default/rollback/reference and exact v3 corrected remains qualified opt-in. Phase I current candidate is I.3 Hotfix 5 Corrected 300 s Healthy Reference Requalification; tolerance budgets remain unfrozen and H.30 remains OPT-IN ONLY pending a separate re-review. See `PROJECT_HANDOFF.md`, `NEW_CHAT_START.md`, `M10_9_4_1_I3_REFERENCE_TRAJECTORY_CONSERVATION_INVENTORY_BASELINE.md` and `milestones/M10.9.4.1.md`.
