...
$Contract=Get-Content 'eng\m10-final-vr2-r3-short-exact-v9-equivalent-shadow-composition-requalification2-contract.json' -Raw | ConvertFrom-Json
...
Require-R3 ($env:NRS_M10_FINAL_VR2_R3_REQUALIFICATION2_ORDINARY_PASS -eq '1') 'Ordinary Release PASS marker missing.'
...
Write-R3Lines (Join-Path $ArtifactRoot '01-contract-and-provenance.txt') @(
    ...
    'gate=R3-SHORT-EXACT-V9-EQUIVALENT-SHADOW-COMPOSITION-REQUALIFICATION2',
    'r2-returned-adjudication=PASS',
    'repair-implementation1-returned-adjudication=PASS',
    ...
    ('execution-contract-sha256='+(FileSha-R3 (Join-Path $Root 'eng\m10-final-vr2-r3-short-exact-v9-equivalent-shadow-composition-requalification2-contract.json'))),
...
Write-R3Lines (Join-Path $ArtifactRoot '06-r3-requalification-summary.txt') @(
    'status=PASS-R3-SHORT-EXACT-V9-EQUIVALENT-SHADOW-COMPOSITION-REQUALIFICATION2',
    'classification=PASS-R3-SHORT-EXACT-V9-EQUIVALENT-SHADOW-COMPOSITION-REQUALIFICATION2',
    'ordinary-release-suite=PASS',
...
Write-R3Lines (Join-Path $ArtifactRoot '07-prequalification-review.txt') @(
    ...
    'finding-2=R3-FUSION-REPAIR-IMPLEMENTATION1-RETURNED-PASS',
...
Write-Host 'R3 short exact-v9-equivalent shadow/composition Requalification 2 adjudication: PASS' -ForegroundColor Green
