...
$rawPhase=PhaseNodes $raw;$s1Phase=PhaseNodes $s1;$s2Phase=PhaseNodes $s2
...
Write-Host 'Two-seed-step preconditioning diagnostic evidence adjudicated.' -ForegroundColor Green
