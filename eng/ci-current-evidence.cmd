...
echo [CI CURRENT EVIDENCE] I.4 known limitations / legacy retirement review...
call scripts\run-phase-i-known-limitations-legacy-retirement-review-audit.cmd || exit /b 1
